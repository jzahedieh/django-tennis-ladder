        ...
        for k, r in results.iteritems():
            ...
            if r != '-':
                ...
                try:
                    ...
                    #print result_object.player.first_name + result_object.player.last_name + 'vs' + result_object.opponent.first_name + result_object.player.last_name + ' ' + str(result_object.result)
                except (Ladder.DoesNotExist, Result.DoesNotExist) as e:
                    print str(season_pk) + ' ' +division_no + ': ' + first_name + last_name + ' vs ' +opp_first_name + opp_last_name + ' ' + str(r)
                    #new_result_object = Result(ladder=ladder_object, player=player_object, opponent=opp_object, result= int(r), date_added=datetime.date(2013,04,16))
